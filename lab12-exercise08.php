...
//    echo $destination . ' Uploaded successfully<br/>';
    ...
    if (in_array($fileType, $validMime) && in_array($extension, $validExt)) {
        echo $destination . 'Uploaded successfully<br/>';
        move_uploaded_file($fileToMove, "/Users/apple/Documents/HTML/htdocs/UPLOADS/" . $destination) 
        or die("error");
    }
    else {
...
//            $destination = "/Users/apple/Documents/HTML/htdocs/UPLOADS/" . $_FILES["file1"]["name"];
